...
class ElementActions {
    ...
    async clickElementNameFromListBySelector(listOfElementsSelector, elementNameToClick) {
        try {
            ...
            elems.forEach(async element => {
                ...
                if (element.getText() === elementNameToClick) {
                    await element.click();
                    console.log("Eliment is clicked...");
                    exit;
                }
            });
    ...
    async clickElementNameFromDropdown(listOfElements, elementNameToClick) {       
        try {  
            console.log("elementNameToClick = " + elementNameToClick);       
            await listOfElements.forEach(async element => {
                const txt = await element.getText();
                console.log("Element = " + txt );
                if(txt === elementNameToClick){
                    await element.click();                   
                }                      
            });
