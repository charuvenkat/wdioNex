...
class NexportSearchPage extends Page {
    ...
    get empProfile() {return $("[class='employee-search-padding ng-binding']")}
    get empNameValidation() {return $("[class='md-headline clickable ng-binding']")}
    get empProfileValidation() {return $$("[class='md-subhead horizontal-padding ng-binding']")}
    ...
    async empNameSearch(EmpNameSearch) {      
        await elementActions.setValue(await this.empName, 'EmpName', EmpNameSearch); 
    }

    async EmpProfileValidaton(){
        let EmpProfileList = await elementActions.getTextFromList(this.empProfileValidation);       
